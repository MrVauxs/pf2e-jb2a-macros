Hooks.once("init", () => {
  ...
  game.settings.register("pf2e-jb2a-macros", "killAnimationsOnKill", {
    ...
    name: game.i18n.localize(
      "pf2e-jb2a-macros.settings.killAnimationsOnKill.name"
    ),
    hint: game.i18n.localize(
      "pf2e-jb2a-macros.settings.killAnimationsOnKill.hint"
    ),
    type: Boolean,
    default: true,
  });
  game.settings.register("pf2e-jb2a-macros", "killAnimationsOnKillNotify", {
    scope: "world",
    config: true,
    name: game.i18n.localize(
      "pf2e-jb2a-macros.settings.killAnimationsOnKillNotify.name"
    ),
    hint: game.i18n.localize(
      "pf2e-jb2a-macros.settings.killAnimationsOnKillNotify.hint"
    ),
    type: Boolean,
    default: true,
  });
