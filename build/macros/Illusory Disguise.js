...
if (args[0] === "on" || testArgs === "on") {
    ...
    let disguise = await warpgate.menu({inputs: [
        {
            type: 'text',
    ...
    ]},{title: game.i18n.localize("pf2e-jb2a-macros.macro.disguise.illusoryDisguise"),
    ...
    disguise = disguise.inputs.map((x, index) => x.length === 0 ? disguiseDefault[index] : x)
